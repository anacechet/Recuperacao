    ...
    <div class="margem">
        <div class="cor">
            <div class="form">
                ...
                <h3>Calculos do Quadrado</h3>

                <input type="hidden" name="idQuadrado" id="idQuadrado" size="25" value="0"><hr>
                <p>Digite o valor dos lados</p>
                <input type="text" class="form-control btn-sm" name="lado" id="lado" size="25" value=""><hr>
                ...
                <button name="processa" id="processa" value="salvar" type="submit" class="btn btn-outline-success btn-sm">Salvar</button><br>  
                </form>
            ...
            <tr>
                ...
                <td>
                    <a href='cadquad.php?processa=editar&idQuadrado=<?php echo $linha['idQuadrado'];?>'>
                ...
                <td scope="row">
                    <a href="consulta.php?idQuadrado=<?php echo $linha['idQuadrado']; ?>&lado=<?php echo $linha['lado'];?>&cor=<?php echo str_replace('#', '%23', $linha['cor']);?>&tabuleiro_idTabuleiro=<?php echo $linha['tabuleiro_idTabuleiro'];?>">
                ...
                <td>
                    <?php echo " <a href='processa.php?processa=excluir&idQuadrado={$linha['idQuadrado']}')>";?>
                    <?php echo " <a href='processa.php?processa=excluir&idQuadrado={$linha['idQuadrado']}')>";?>
